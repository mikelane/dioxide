...
def step_create_config_object(context: Context) -> None:
    ...
    context.test_config = ConfigObject('localhost', 5432)
...
def step_register_instance(context: Context) -> None:
    ...
    context.container.register_instance(ConfigObject, context.test_config)
...
def step_resolve_config_twice(context: Context) -> None:
    ...
    context.resolved1 = context.container.resolve(ConfigObject)
    context.resolved2 = context.container.resolve(ConfigObject)
...
def step_verify_same_instance(context: Context) -> None:
    ...
    assert context.resolved1 is context.test_config, 'Instance provider should return the original object'
    assert context.resolved2 is context.test_config, 'Instance provider should return the original object'
...
def step_define_user_service(context: Context) -> None:
    ...
    context.user_service_class = UserService
...
def step_resolve_class_multiple_times(context: Context) -> None:
    ...
    context.instance1 = context.container.resolve(UserService)
    context.instance2 = context.container.resolve(UserService)
    context.instance3 = context.container.resolve(UserService)
...
def step_define_factory(context: Context) -> None:
    ...
    def create_db_connection() -> DatabaseConnection:
        ...
        return DatabaseConnection(f'postgresql://localhost:5432/db_{context.call_count}')

    context.factory = create_db_connection
...
def step_resolve_factory_multiple_times(context: Context) -> None:
    ...
    context.connection1 = context.container.resolve(DatabaseConnection)
    context.connection2 = context.container.resolve(DatabaseConnection)
    context.connection3 = context.container.resolve(DatabaseConnection)
